...
from Classes.Node import Positions
...
def run(location):
    ...
    with open("Classes/dics/graph.json", "w") as file:
        file.writelines(json.dumps(neighb))

    with open("Classes/dics/edges.txt", "w") as file:
        for item in edgesList:
            file.write("%s\n" % str(item))

    with open("Classes/dics/nodes.txt", "w") as file:
    ...
    with open("Classes/dics/graphb.json", "w") as file:
        file.writelines(json.dumps(neighb))

    with open("Classes/dics/edgesb.txt", "w") as file:
        for item in edgesList:
            file.write("%s\n" % str(item))

    with open("Classes/dics/nodesb.txt", "w") as file:
        for item in nodeList:
            file.write("%s\n" % str(item))
